module.exports = {
    ...
    filter: function(data, Bot, Config, Helpers) {
        ...
        this.isCode(data.message, function(format) {
            ...
            if (format) {
                ...
                var paste = new Pastee(Config.API.pastee.key);
    ...
    isCode: function(message, cb) {
        ...
        function HTML(input) {
            ...
            score += input.m(/<div>/) && input.m(/<\/div>/) ? 1 : 0;
            score += input.m(/[\s\n]*class=/) ? 1 : 0;
            return score;
        }
