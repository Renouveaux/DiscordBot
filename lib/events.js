module.exports = {
  ...
  init: function(Bot, Config, Helpers, Db) {
  ...
  onMessage: function(data, Bot, Config, Helpers) {
    ...
    if(data.message.match(/[\r\n]/gm)){ // si le message ne fait qu'une ligne, on passe la detection de code.
  ...
  onPresence: function(data, Bot, Config, Helpers, Db) {

    this.database(data, Bot, Config, Helpers, Db);
